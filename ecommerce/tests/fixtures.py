...
def db_fixture_setup(django_db_setup, django_db_blocker):
    ...
    with django_db_blocker.unblock():
        ...
        call_command("loaddata", "test_db_admin_fixture.json")

        # Load inventory-related fixtures
        call_command(
            "loaddata",
            "test_db_type_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_brand_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_product_attribute_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_product_attribute_value_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_category_fixture.json",
        )

        # Load promotion-related fixtures
        call_command(
            "loaddata",
            "test_db_promotion_type_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_coupon_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_promotion_fixture.json",
        )

        # Load product-related fixtures
        call_command(
            "loaddata",
            "test_db_product_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_product_inventory_fixture.json",
        )

        # Load remaining fixtures
        call_command(
            "loaddata",
            "test_db_media_fixture.json",
        )
        call_command(
            "loaddata",
            "test_db_stock_fixture.json",
        )
